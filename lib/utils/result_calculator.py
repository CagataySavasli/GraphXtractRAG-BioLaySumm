...
def evaluate(preds, refs, docs=None):
    ...
    # Relevance scores
    print("Starting ROUGE and BERTScore calculation...")
    ...
    print("ROUGE calculation completed.")
